...
[ ] 상품 목록 검색 기능을 구현합니다.
[ ]  베스트상품 데이터는 https://panda-market-api.vercel.app/docs/에 명세된 GET 메소드 "/products"의 정렬 기준 favorite을 사용해주세요.
...
## 멘토님께 드리는 글
- 아직 익숙하지 못해 component를 어떻게 분할 구분해야 할지 판단이 잘 안됨.
- 서버에 isFavorite 정보가 없고 FavoriteCount만 있어 고민하다 별도 처리하지 않음.
- Market.jsx에서 어떤 내용들이 재사용되어 분할하여 별도 함수로 가져가야할지 구분이 안되어 분할하지 못함